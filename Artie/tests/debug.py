...
if __name__ == "__main__":
    ...
    ms = 300
    batchsize = 32
    shape = (batchsize, *[s for s in provider.generate_n_spectrograms(n=1, ms=ms, label_fn=_label_fn)][0][0].shape)
    # TODO: Need to look up what Conv2D expects as input shape - probably (batch, height, width, channels)
    raise NotImplementedError
    datagen = provider.generate_n_spectrogram_batches(n, batchsize, ms, _label_fn, normalize=True, forever=True)
